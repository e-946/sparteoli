...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::group(['middleware' => ['can:admin']], function () {
        ...
        Route::post('lookup-search/{resource}', [LookupSearchController::class, 'store'])
            ->name('lookup-quick-create');
        ...
        Route::prefix('nature')->group(function () {
            ...
            Route::delete('/{id}', [NatureController::class, 'destroy'])
                ->name('destroy-nature')
                ->where('id', '[0-9]+');
            Route::get('/{id}/update', [NatureController::class, 'edit'])
                ->name('edit-nature')
                ->where('id', '[0-9]+');
            Route::put('/{id}/update', [NatureController::class, 'update'])
                ->name('update-nature')
                ->where('id', '[0-9]+');
        });
        Route::prefix('type')->group(function () {
            ...
            Route::delete('/{id}', [TypeController::class, 'destroy'])
                ->name('destroy-type')
                ->where('id', '[0-9]+');
            Route::get('/{id}/update', [TypeController::class, 'edit'])
                ->name('edit-type')
                ->where('id', '[0-9]+');
        ...
        Route::prefix('fireprotection')->group(function () {
            ...
            Route::delete('/{id}', [FireprotectionController::class, 'destroy'])
                ->name('destroy-fireprotection')
                ->where('id', '[0-9]+');
            Route::get('/{id}/update', [FireprotectionController::class, 'edit'])
                ->name('edit-fireprotection')
                ->where('id', '[0-9]+');
            Route::put('/{id}/update', [FireprotectionController::class, 'update'])
                ->name('update-fireprotection')
                ->where('id', '[0-9]+');
        });
        Route::prefix('rescuer')->group(function () {
            ...
            Route::delete('/{id}', [RescuerController::class, 'destroy'])
                ->name('destroy-rescuer')
                ->where('id', '[0-9]+');
            Route::get('/{id}/update', [RescuerController::class, 'edit'])
                ->name('edit-rescuer')
                ->where('id', '[0-9]+');
            Route::put('/{id}/update', [RescuerController::class, 'update'])
                ->name('update-rescuer')
                ->where('id', '[0-9]+');
        });
        Route::prefix('problem')->group(function () {
            ...
            Route::delete('/{id}', [ProblemController::class, 'destroy'])
                ->name('destroy-problem')
                ->where('id', '[0-9]+');
            Route::get('/{id}/update', [ProblemController::class, 'edit'])
                ->name('edit-problem')
                ->where('id', '[0-9]+');
            Route::put('/{id}/update', [ProblemController::class, 'update'])
                ->name('update-problem')
                ->where('id', '[0-9]+');
        });
        Route::prefix('placefreature')->group(function () {
            ...
            Route::delete('/{id}', [PlacefreatureController::class, 'destroy'])
                ->name('destroy-placefreature')
                ->where('id', '[0-9]+');
            Route::get('/{id}/update', [PlacefreatureController::class, 'edit'])
                ->name('edit-placefreature')
                ->where('id', '[0-9]+');
            Route::put('/{id}/update', [PlacefreatureController::class, 'update'])
                ->name('update-placefreature')
                ->where('id', '[0-9]+');
        });
        Route::prefix('meanused')->group(function () {
            ...
            Route::delete('/{id}', [MeanusedController::class, 'destroy'])
                ->name('destroy-meanused')
                ->where('id', '[0-9]+');
            Route::get('/{id}/update', [MeanusedController::class, 'edit'])
                ->name('edit-meanused')
                ->where('id', '[0-9]+');
            Route::put('/{id}/update', [MeanusedController::class, 'update'])
                ->name('update-meanused')
                ->where('id', '[0-9]+');
        });
        Route::prefix('placeuse')->group(function () {
            ...
            Route::delete('/{id}', [PlaceuseController::class, 'destroy'])
                ->name('destroy-placeuse')
                ->where('id', '[0-9]+');
            Route::get('/{id}/update', [PlaceuseController::class, 'edit'])
                ->name('edit-placeuse')
                ->where('id', '[0-9]+');
            Route::put('/{id}/update', [PlaceuseController::class, 'update'])
                ->name('update-placeuse')
                ->where('id', '[0-9]+');
        });
        ...
        Route::prefix('occurrence')->group(function () {
            Route::prefix('{occurrence_id}/victim')->where(['occurrence_id' => '[0-9]+'])->group(function () {
                Route::delete('/{id}', [VictimController::class, 'destroy'])
                    ->name('destroy-victim')
                    ->where('id', '[0-9]+');
                Route::get('/{id}/update', [VictimController::class, 'edit'])
                    ->name('edit-victim')
                    ->where('id', '[0-9]+');
                Route::put('/{id}/update', [VictimController::class, 'update'])
                    ->name('update-victim')
                    ->where('id', '[0-9]+');
            });
            ...
            Route::prefix('{occurrence_id}/resource')->where(['occurrence_id' => '[0-9]+'])->group(function () {
                Route::delete('/{id}', [ResourceController::class, 'destroy'])
                    ...
                    ->where('id', '[0-9]+');
                Route::get('/{id}/update', [ResourceController::class, 'edit'])
                    ->name('edit-resource')
                    ->where('id', '[0-9]+');
                Route::put('/{id}/update', [ResourceController::class, 'update'])
                    ->name('update-resource')
                    ->where('id', '[0-9]+');
            });

            Route::delete('/{id}', [OccurrenceController::class, 'destroy'])
                ->name('destroy-occurrence')
                ->where('id', '[0-9]+');
            Route::get('/{id}/update', [OccurrenceController::class, 'edit'])
                ->name('edit-occurrence')
                ->where('id', '[0-9]+');
            Route::put('/{id}/update', [OccurrenceController::class, 'update'])
                ->name('update-occurrence')
                ->where('id', '[0-9]+');
        });
        Route::get('profile/password/{id}', [UserController::class, 'changePasswordID'])
            ->name('passwordId')
            ->where('id', '[0-9]+');
    });
    Route::prefix('nature')->group(function () {
    ...
    Route::prefix('fireprotection')->group(function () {
        ...
        Route::get('/{id}', [FireprotectionController::class, 'show'])
            ->name('show-fireprotection')
            ->where('id', '[0-9]+');
    });
    ...
    Route::prefix('occurrence')->group(function () {
        ...
        Route::get('/{id}/pdf', [OccurrenceController::class, 'toPdf'])
            ->name('toPdf-occurrence')
            ->where('id', '[0-9]+');
    ...
    Route::put('profile/password/{id}', [UserController::class, 'storePassword'])
        ->name('password-store')
        ->where('id', '[0-9]+');
});
