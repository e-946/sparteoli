        ...
        <div class="mb-2 mx-sm-3">
            ...
            <div class="form-row mb-3">
                <div class="col mr-3">
                    ...
                    <select id="rescuer" type="number" name="rescuer" class="form-control" required>
                        <option selected class="text-bold" disabled>Selecione</option>
            ...
            <div class="form-row">
                <div class="col-4">
                    ...
                    <select id="fatal" type="number" name="fatal" class="form-control" required onChange="ckChange()">
                        <option selected class="text-bold" disabled>Selecione</option>
                        <option value="true">Vítima fatal</option>
                        <option value="false">Vítima não fatal</option>
                    </select>
                </div>
                <div class="col-4">
                    ...
                    <select id="conscious" type="number" name="conscious" class="form-control" required>
                        <option selected class="text-bold" disabled>Selecione</option>
                        <option value="true">Vítima consciente</option>
                        <option value="false">Vítima não consciente</option>
                    </select>
                </div>
            </div>
        </div>
